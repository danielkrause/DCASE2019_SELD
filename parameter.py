...
def get_params(argv):
    ...
    params = dict(
        ...
        # INPUT PATH
        dataset_dir='D:/seld-dcase2019-master/seld-dcase2019-master/data/',  # Base folder containing the foa/mic and metadata folders

        # OUTPUT PATH
        feat_label_dir='D:/seld-dcase2019-master/seld-dcase2019-master/data/feat_label/',  # Directory to dump extracted features and labels
        ...
        model_nb = 3,     #1-3 according to the submission number
    ...
    params['patience'] = 50   # Stop training if patience is reached
