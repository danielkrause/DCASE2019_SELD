...
class DataGenerator(object):
    def __init__(
            self, dataset='foa', feat_label_dir='', is_eval=False, split=1, batch_size=16, seq_len=64,
            shuffle=True, per_file=False, channels_separate=False
    ):
        ...
        while 1:
            ...
            if self._is_eval:
                for i in range(self._nb_total_batches):
                    ...
                    if not self._channels_separate:
                        yield feat
                    else:
                        mag1 = feat[:, 0, :, :]
                        mag2 = feat[:, 1, :, :]
                        ...
                        phase3 = feat[:, 6, :, :]
                        phase4 = feat[:, 7, :, :]
                        yield [mag1, mag2, mag3, mag4, phase1, phase2, phase3, phase4]
                ...
                for i in range(self._nb_total_batches):
                    ...
                    if not self._channels_separate:
                        ...
                        phase3 = feat[:, 6, :, :]
                        phase4 = feat[:, 7, :, :]
                        yield [mag1, mag2, mag3, mag4, phase1, phase2, phase3, phase4], label
