...
def get_model(data_in, data_out, dropout_rate, nb_cnn2d_filt, pool_size,
    ...
    spec_mag_cnn = inp
    spec_mag_cnn = SeparableConv2D(filters=nb_cnn2d_filt, kernel_size=(3, 3),
    ...
    for i, convCnt in enumerate(pool_size):
        doa = SeparableConv2D(filters=nb_cnn2d_filt//2, kernel_size=(3, 3),
    ...
    for i, convCnt in enumerate(pool_size):
        sed = SeparableConv2D(filters=nb_cnn2d_filt//2, kernel_size=(3, 3),
